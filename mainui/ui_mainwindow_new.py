...
"QTabBar::tab{height:150}")
        ...
        self.tab_4.setStyleSheet(u"background-image: url(:/\u5fae\u4fe1\u56fe\u7247_20240516211516.jpg);")
        self.pushButton_exit = QPushButton(self.tab_4)
        self.pushButton_exit.setObjectName(u"pushButton_exit")
        self.pushButton_exit.setGeometry(QRect(290, 470, 75, 23))
        self.pushButton_exit.setStyleSheet(u"background-image: url();\n"
...
"padding: 5px 10px;")
        ...
        self.label_name1.setGeometry(QRect(540, 450, 54, 16))
        self.label_name1.setStyleSheet(u"background: transparent;")
        self.label_name2 = QLabel(self.tab_4)
        self.label_name2.setObjectName(u"label_name2")
        self.label_name2.setGeometry(QRect(540, 470, 54, 16))
        self.label_name2.setStyleSheet(u"background: transparent;")
        self.label_name3 = QLabel(self.tab_4)
        self.label_name3.setObjectName(u"label_name3")
        self.label_name3.setGeometry(QRect(540, 490, 54, 16))
        self.label_name3.setStyleSheet(u"background: transparent;")
        self.label_main1 = QLabel(self.tab_4)
        self.label_main1.setObjectName(u"label_main1")
        self.label_main1.setGeometry(QRect(190, 30, 351, 81))
        self.label_main1.setStyleSheet(u"background: transparent;\n"
"font: 9pt \"\u534e\u6587\u884c\u6977\";")
...
"border-radius: 5px;")
    ...
    def show_info(self, Table, index, Index):
            ...
            match index:
                    case 0:
                            self.dewidget = DEWidget(title, self.basicsearch_info[row])
                    case 1:
                            self.dewidget = DEWidget(title, self.partical_publicationlist[row])
                    case 2:
                            self.dewidget = DEWidget(title, self.coperate_publicationlist[row])
            self.dewidget.show()
    ...
    def particalsearch(self):
            ...
            match choice:
                    case 0:
                            self.partical_titlelist, self.partical_publicationlist = Function_index.fuzzy_search(
                                    search_word, self.inverted_index, self.title_to_info)
                    case 1:
                            self.partical_titlelist, self.partical_publicationlist = Function_index.keywords_search(
                                    search_word, self.inverted_index, self.title_to_info)
    ...
    def virtualanalysis(self):
            ...
            selected_author = self.comboBox_virtualanalysis.currentText()
            author_a = self.lineEdit_va1.text()
            self.coperate_titlelist, self.coperate_publicationlist = Function_index.corperation(author_a,
                                                                                                selected_author,
                                                                                                self.author_to_titles)
